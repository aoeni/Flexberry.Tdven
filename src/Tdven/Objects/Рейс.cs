...
namespace IIS.Tdven
{
    ...
    public class Рейс : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tdven.DetailArrayOfИнфБронь fИнфБронь;
        ...
        public virtual IIS.Tdven.DetailArrayOfИнфБронь ИнфБронь
        {
            get
            {
                ...
                {
                    this.fИнфБронь = new IIS.Tdven.DetailArrayOfИнфБронь(this);
                }
                IIS.Tdven.DetailArrayOfИнфБронь result = this.fИнфБронь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РейсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РейсE", typeof(IIS.Tdven.Рейс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РейсL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РейсL", typeof(IIS.Tdven.Рейс));
                }
            }
        }
    }
