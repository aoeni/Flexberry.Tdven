...
namespace IIS.Tdven
{
    ...
    public class ИнфБронь : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tdven.Пассажир fПассажир;
        
        private IIS.Tdven.Рейс fРейс;
        ...
        [PropertyStorage(new string[] {
                "Пассажир"})]
        [NotNull()]
        public virtual IIS.Tdven.Пассажир Пассажир
        {
            get
            {
                ...
                IIS.Tdven.Пассажир result = this.fПассажир;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Tdven.Рейс.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Рейс"})]
        public virtual IIS.Tdven.Рейс Рейс
        {
            get
            {
                ...
                IIS.Tdven.Рейс result = this.fРейс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ИнфБроньE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИнфБроньE", typeof(IIS.Tdven.ИнфБронь));
                }
            }
        }
    }
    ...
    public class DetailArrayOfИнфБронь : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Tdven.DetailArrayOfИнфБронь members)

        // *** End programmer edit section *** (IIS.Tdven.DetailArrayOfИнфБронь members)
        ...
        /// </summary>
        public DetailArrayOfИнфБронь(IIS.Tdven.Рейс fРейс) : 
                base(typeof(ИнфБронь), ((ICSSoft.STORMNET.DataObject)(fРейс)))
        {
        }
        
        public IIS.Tdven.ИнфБронь this[int index]
        {
            get
            {
                return ((IIS.Tdven.ИнфБронь)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Tdven.ИнфБронь dataobject)
        {
