...
namespace IIS.Tdven
{
    ...
    public class МестоНаРейс : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tdven.КлассБилета fКласс;
        ...
        public virtual IIS.Tdven.КлассБилета Класс
        {
            get
            {
                ...
                IIS.Tdven.КлассБилета result = this.fКласс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МестоНаРейсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МестоНаРейсE", typeof(IIS.Tdven.МестоНаРейс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МестоНаРейсL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МестоНаРейсL", typeof(IIS.Tdven.МестоНаРейс));
                }
            }
        }
    }
