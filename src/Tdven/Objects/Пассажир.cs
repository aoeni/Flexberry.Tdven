...
namespace IIS.Tdven
{
    ...
    public class Пассажир : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tdven.МестоНаРейс fМестоНаРейс;
        
        private IIS.Tdven.КодБрони fКодБрони;
        ...
        [PropertyStorage(new string[] {
                "КодБрони"})]
        [NotNull()]
        public virtual IIS.Tdven.КодБрони КодБрони
        {
            get
            {
                ...
                IIS.Tdven.КодБрони result = this.fКодБрони;
        ...
        [PropertyStorage(new string[] {
                "МестоНаРейс"})]
        [NotNull()]
        public virtual IIS.Tdven.МестоНаРейс МестоНаРейс
        {
            get
            {
                ...
                IIS.Tdven.МестоНаРейс result = this.fМестоНаРейс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПассажирE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирE", typeof(IIS.Tdven.Пассажир));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПассажирL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирL", typeof(IIS.Tdven.Пассажир));
                }
            }
        }
    }
